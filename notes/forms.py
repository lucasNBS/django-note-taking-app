...
class NoteForm(forms.ModelForm):
    ...
    def clean_folder(self):
        ...
        permission = (
            Permission.objects.filter(data__id=folder.id, user=self.creator)
    ...
    def _create_note_access_to_new_folder(self, new_note_instance, new_folder_permissions):
    ...
    def _handle_alter_permission_when_folder_change(
        self, previous_note_instance, new_note_instance
    ):
        ...
        if (
            previous_folder_permissions_but_creator
            and previous_note_instance.folder.title != "General"
        ):
    ...
    def save(self, *args, **kwargs):
        ...
        if already_created:
            ...
            if self.instance.folder != previous_note_instance.folder:
                self._handle_alter_permission_when_folder_change(
                    previous_note_instance, self.instance
                )
