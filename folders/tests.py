...
class FoldersOperationsTestCase(TestCase):
    ...
    def setUpTestData(self):
        ...
        Permission.objects.create(
            data=self.folder, user=self.client_user, type=PermissionType.CREATOR
        )
...
class FoldersValidationTestCase(TestCase):
    ...
    def test_editor_should_update_folder(self):
        Permission.objects.create(
            data=self.folder, user=self.client_user, type=PermissionType.EDITOR
        )
        ...
        self.client.post(url, folder_new_data)
    ...
    def test_reader_should_not_update_folder(self):
        Permission.objects.create(
            data=self.folder, user=self.client_user, type=PermissionType.READER
        )
...
class FoldersAutocompleteTestCase(TestCase):
    ...
    def test_autocomplete_not_list_non_shared_folder(self):
        models.Folders.objects.create(title="Folder 2")
