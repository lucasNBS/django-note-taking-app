...
from . import choices, constants, models, views
...
class PermissionsOperationsTestCase(TestCase):
    ...
    def setUpTestData(self):
        ...
        self.user_to_share_data_permission = models.Permission.objects.create(
            data=self.folder, user=self.user_to_share_data_with, type=choices.PermissionType.READER
        )
...
class PermissionsValidationTestCase(TestCase):
    ...
    def test_editor_user_should_not_update_permissions(self):
        ...
        share_data = {"type": self.user_to_share_data_with_permission.type}

        kwargs = {"data_id": self.folder.id, "id": self.user_to_share_data_with_permission.id}
