...
from core.permissions import HasAccessToPermissions, IsCreatorOfShareableModelData
        ...
        if serializer.is_valid():
            ...
            if serializer.data["id"] is None:
                raise exceptions.ValidationError(
                    {"message": "The selected user already has permission"}
                )
...
class DetailNotePermissionView(
    DetailDataPermissionView, mixins.UpdateModelMixin, mixins.DestroyModelMixin
):
    ...
    def update(self, request, pk):
        ...
        if permission.type == PermissionType.CREATOR:
            raise exceptions.ValidationError({"message": "Cannot edit CREATOR permission"})
    ...
    def delete(self, request, pk=None):
        ...
        if permission.type == PermissionType.CREATOR:
            raise exceptions.ValidationError({"message": "Cannot delete CREATOR permission"})
